...
import "../Dashboard/Organizations/Organization.css";
...
const AdminOrganization = ({
  ...
  useEffect(() => {
    dispatch(fetchAdminOrganization(organizationId));
...
export default connect(mapStateToProps)(AdminOrganization);
