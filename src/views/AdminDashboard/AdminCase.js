...
import { fetchAdminCase, inviteParty } from "../../store/actions/case";
...
import PLUS from "../../assets/images/plus.png";
import InviteForm from "../Dashboard/Cases/InviteForm";
import ShimmerEffect from "../../components/shimmer";

const { Step } = Steps;

const AdminCase = ({ dispatch, caseData, user, organizations, casesData }) => {
  ...
  //initial data fetch
  useEffect(() => {
    dispatch(fetchAdminCase(caseId));
    dispatch(fetchUsers());
    dispatch(fetchUser());
...
export default connect(mapStateToProps)(AdminCase);
