...
const OrganizationsList = ({ dispatch, organizations, user, history }) => {
	...
	const showCreateOrganizationModal = () => setCreateOrganizationModalVisibility(true)

	const closeCreateOrganizationModal = () => setCreateOrganizationModalVisibility(false)
	...
	const renderOrganizations = () => {
		if (organizations.length > 0) {
			...
			return <OrganizationsTable organizations={organizations} user={user._id} />
		}
		return (
			<Card bordered={false}>
