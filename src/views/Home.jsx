        ...
        <Row justify="center" align="middle" className="home-hero">
          <Col xs={24} sm={24} md={12} lg={12} xl={12}>
            <div className="home-hero-container">
              ...
              <Paragraph>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi qui iure modi. Qui ess
                temporibus porro quia suscipit eius ab accusantium repellat sint a incidunt iure, qu
                laborum eveniet excepturi.
              </Paragraph>

              <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                <Col><Button type="primary">How it works</Button></Col>
