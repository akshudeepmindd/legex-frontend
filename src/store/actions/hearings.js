...
export function createHearing(payload) {
  return async (dispatch) => {
    ...
    try {
      const response = $http({ url: `/hearings`, data: payload, method: 'POST' });
      return response;
    } catch (error) {
      dispatch(requestFailure(error));
    }
...
export function updateHearing(payload) {
  return async (dispatch) => {
    ...
    try {
      const response = $http({ url: `/hearings/${payload._id}`, data: payload, method: 'PUT' });
      return response;
    } catch (error) {
      dispatch(requestFailure(error));
    }
...
export function deleteHearing(payload) {
  return async (dispatch) => {
    ...
    try {
      const response = $http({ url: `/hearings/${payload._id}`, method: 'DELETE' });
      return response;
    } catch (error) {
      dispatch(requestFailure(error));
    }
